import stiLogo from '../assets/icons/sti_logo.jpg';
import arellanoLogo from '../assets/icons/arellano_logo.jpg';
...
export const education = [
  ...
  },
  {
    ...
    degree: 'Information and Communication Technologies (ICT) | With Honors',
